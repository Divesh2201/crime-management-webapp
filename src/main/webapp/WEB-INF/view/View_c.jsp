...
<body>
	...
	<div id="wrapper">
		<div id="header">
			<h2 style="text-align:center;margin:20px">View CyberCrime Reports</h2>
		</div>
	</div>
	...
	<div id="container">
		...
		<div id="content">	
			<table class="table table-bordered table-striped table-dark" style="text-align:center">
				...
				<c:forEach var="tempReport" items="${listCyberComplaints}">
				
					<c:url var="deleteLink" value="/admin/deleteCyberCrimeComplaints">
					...
					<tr>
						...
						<td> ${tempReport.account_number} </td>
