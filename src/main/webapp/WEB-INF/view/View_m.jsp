...
<head>
	<title>View Missing Reports</title>
...
<body>
	...
	<div id="wrapper">
		<div id="header">
			<h2 style="text-align:center;margin:20px">View Missing Reports</h2>
		</div>
	</div>
	...
	<div id="container">
		...
		<div id="content">
			...
			<table class="table table-bordered table-striped table-dark" style="text-align:center">
				...
				<c:forEach var="tempReport" items="${listMissingComplaints}">
				
				
				<c:url var="deleteLink" value="/admin/deleteMissingComplaints">
					...
					<c:url var="green" value="/admin/changeStatustoGreen">
						...
						<c:param name="changeStatusComplaintType" value="4" />
					</c:url>	
